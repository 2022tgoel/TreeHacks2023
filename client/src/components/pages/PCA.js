...
import MNIST from "../../../images/Mnist_Line.png"
...
const PCA = () => {
    ...
    return (
        ...
        />
        <div>
          <img src={MNIST} style={{width: "90vw"}}></img>
        </div>
        <p>Class Number</p>
        <MovingCat></MovingCat>
        </div>
